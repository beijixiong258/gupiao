...
class BankuaiXuanguTool(BaseTool):
    ...
    description = (
        ...
        "Returns executable recommendations only when their weighted after-cost model return is positive; failed validation "
        "lowers confidence but does not hide positive model estimates. Non-positive stocks remain available in model_ranking. "
